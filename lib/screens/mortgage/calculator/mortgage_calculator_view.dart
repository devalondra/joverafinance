...
class MortgageCalculatorView extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Builder(
            builder: (_) {
              final String priceText = controller.propertyPrice.round().toString();
                ...
                child: Column(
                  children: [
                    HeadingRow(
                      ...
                      value: "AED ${controller.propertyPrice.round()}",
                    ...
                    CalculatorSlider(
                      ...
                      value: controller.propertyPrice,
                    ),
                  ],
                ),
              );
          ...
          Builder(
            builder: (_) {
              final String yearsText = controller.propertyPeriod.toString();
              ...
              void commitYears(String value) {
                ...
                final int clamped =
                    parsed
                        ...
                        .toInt();
                controller.propertyPeriod = clamped;
                controller.yearsInputController.text = clamped.toString();
              }

              void previewYears(String value) {
                if (value.isEmpty) {
                  controller.propertyPeriod = MortgageController.mortgageYearsMin;
                  return;
                }
                final int? parsed = int.tryParse(value);
                if (parsed == null) return;
                final int next =
                    parsed >= MortgageController.mortgageYearsMin &&
                        ...
                        ? parsed
                        : MortgageController.mortgageYearsMin;
                controller.propertyPeriod = next;
              }
                ...
                child: Column(
                  children: [
                    HeadingRow(
                      ...
                      value: "${controller.propertyPeriod} Years",
                    ...
                    CalculatorSlider(
                      ...
                      onChanged: (v) {
                        controller.propertyPeriod = v.round();
                      },
                      value: controller.propertyPeriod.toDouble(),
                    ),
                  ],
                ),
              );
          ...
          Builder(
            builder: (_) {
              final double price = controller.propertyPrice;
              final double advancePercent =
                  price == 0 ? 0 : (controller.advancePayment / price) * 100;
              final String advanceText =
                  controller.advancePayment.round().toString();
                ...
                child: Column(
                  children: [
                    HeadingRow(
                      ...
                      value:
                          "AED ${controller.advancePayment.round()} (${advancePercent.round()}%)",
                    ...
                    CalculatorSlider(
                      ...
                      value: controller.advancePayment,
                    ),
                  ],
                ),
              );
          ...
          Builder(
            builder: (_) {
              ...
              final double loanPercent =
                  price == 0 ? 0 : (controller.loanAmount / price) * 100;
              final String loanText = controller.loanAmount.round().toString();
                ...
                child: Column(
                  children: [
                    HeadingRow(
                      heading: "Loan Amount",
                      value:
                          "AED ${controller.loanAmount.round()} (${loanPercent.round()}%)",
          ...
          Builder(
            builder: (_) {
              final String interestText = controller.interestRate
                  .toStringAsFixed(1);
              ...
              void commitInterest(String value) {
                ...
                controller.interestRate =
                    double.parse(clamped.toStringAsFixed(1));
                ...
                child: Column(
                  children: [
                    HeadingRow(
                      ...
                      value: "${controller.interestRate.toStringAsFixed(1)} %",
          ...
          isLogged
              ? CustomButton(
                onPressed: () {
                  AppNavigator.push(const MortgageInformationView());
                },
                text: "Apply",
              )
              : CustomButton(
